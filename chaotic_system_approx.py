""" Approximation of Lorenz attractor dynamical systems """
import time
import argparse
...
from data_loader import ChaoticDSData
import utils
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=" Lorenz attractor training and evaluation script "
    )
    ...
    # Custom sigma, rho and beta parameters
    parser.add_argument(
        "-cp", "--custom_params", nargs="*", type=float, default=[10.0, 28.0, 8.0 / 3.0]
    )
    # Hyperparameters of the vector field
    parser.add_argument("--num_dims", type=int, default=3)
